...
A full-stack WoT-based smart irrigation system that automates watering decisions using real-time environmental MQTT, crop information, MQTT communication, and external weather/crop APIs.
